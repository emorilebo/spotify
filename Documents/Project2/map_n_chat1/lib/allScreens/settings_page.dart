...
import 'package:map_n_chat1/allConstants/app_constants.dart';
import 'package:map_n_chat1/allConstants/color_constants.dart';
import 'package:map_n_chat1/allConstants/constants.dart';
import 'package:map_n_chat1/allModels/user_chat.dart';
import 'package:map_n_chat1/allProviders/setting_provider.dart';
...
class _SettingsPageStateState extends State<SettingsPageState> {
  ...
  Future uploadFile() async {
    ...
    UploadTask uploadTask =
        settingProvider.uploadFile(avatarImageFie!, fileName);
    try {
      TaskSnapshot snapshot = await uploadTask;
      photoUrl = await snapshot.ref.getDownloadURL();

      UserChat uploadInfo = UserChat(
        id: id,
        photoUrl: photoUrl,
        nickname: nickname,
        aboutMe: aboutMe,
      ...
      settingProvider
          .updateDataFirestore(
              FirestoreConstants.pathUserCollection, id, uploadInfo.toJson())
          .then((data) async {
